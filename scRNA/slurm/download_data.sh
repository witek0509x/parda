...
cd /net/tscratch/people/plgbsadlej/scRNA/data/mouse/datasets/cellXGene

for ID in "${IDS[@]}"; do
    echo "Downloading data for ID: $ID"
    wget "https://datasets.cellxgene.cziscience.com/$ID.h5ad" &
done
